...
import 'package:mufeed_app/presentation/screens/flashcard_session_screen.dart';
...
Widget _buildApp() {
  return ProviderScope(
    ...
    child: const MaterialApp(
      ...
      locale: Locale('fr'),
      home: FlashcardSessionScreen(lessonId: 1),
    ),
  );
}

void main() {
  group('FlashcardSessionScreen', () {
    ...
    testWidgets('shows empty state when no items', (tester) async {
      ...
      expect(find.text('Aucun élément à réviser'), findsOneWidget);
    });
